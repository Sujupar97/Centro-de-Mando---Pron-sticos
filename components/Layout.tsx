...
import { HomeIcon, ChartBarIcon, PlusCircleIcon, SparklesIcon, CogIcon, CalendarDaysIcon, UsersIcon, ArrowLeftOnRectangleIcon } from './icons/Icons';
             ...
             <nav className="flex -mb-px overflow-x-auto">
                {availableNavItems.map((item) => (
                     <button
                        ...
                        className={`flex flex-col items-center justify-center w-24 py-3 px-2 text-xs font-medium transition-colors duration-200 flex-shrink-0 ${
                            currentPage === item.id 
