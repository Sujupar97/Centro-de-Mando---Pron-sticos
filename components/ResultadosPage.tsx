            ...
            return (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-emerald-500/20 text-emerald-400 font-bold text-sm rounded-xl border border-emerald-500/30 hover:bg-emerald-500/30 transition-all"
                    >
                        Reintentar
                    </button>
                </div>
