...
export const BetTable: React.FC<BetTableProps> = ({ bets, onDeleteBet }) => {
  return (
    <div className="space-y-6">
        ...
        {bets.length > 0 ? (
            ...
            <div className="text-center p-8 md:p-12 bg-gray-800 rounded-lg shadow-inner border border-dashed border-gray-700">
                ...
                <p className="text-gray-400 mt-2">Haz clic en "Añadir Apuesta" para empezar a registrar tus tickets.</p>
            </div>
        )}
    </div>
  );
