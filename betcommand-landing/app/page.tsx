...
export default function Home() {
  return (
    <div className="min-h-screen bg-slate-950 font-sans text-slate-200 selection:bg-emerald-500 selection:text-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-white/5 backdrop-blur-md transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2 animate-fade-in">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-emerald-500 to-emerald-600 flex items-center justify-center shadow-[0_0_20px_rgba(16,185,129,0.4)]">
              <ChartBarIcon className="w-6 h-6 text-white" />
            </div>
            <span className="text-xl font-display font-bold text-white tracking-tight">
              Bet<span className="text-emerald-500">Command</span>
            </span>
          </div>
      ...
      <header className="relative pt-40 pb-32 md:pt-60 md:pb-48 px-6 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-[1920px] h-full pointer-events-none">
          <div className="absolute top-[-10%] left-[10%] w-[600px] h-[600px] bg-emerald-500/10 rounded-full blur-[120px] animate-pulse-slow"></div>
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10 flex flex-col items-center">
          ...
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-display font-bold text-white tracking-tighter leading-[0.95] mb-10 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            Domina el <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-b from-emerald-500 to-emerald-600 relative">
              Juego.
              {/* Text Glow Effect */}
              <span className="absolute inset-0 bg-emerald-500/20 blur-2xl -z-10 bg-clip-text text-transparent" aria-hidden="true">Juego.</span>
            </span>
          </h1>
          ...
          <div className="mt-20 pt-10 border-t border-white/5 w-full max-w-4xl animate-fade-in" style={{ animationDelay: '0.5s' }}>
            ...
            <div className="flex flex-wrap justify-center gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
              ...
              <span className="text-xl font-display font-bold text-white">Bet<span className="text-emerald-500">365</span></span>
                ...
                <div className="flex-1 p-8 space-y-6 bg-slate-900">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                      <div className="h-10 w-10 bg-emerald-500/20 rounded-full"></div>
                    </div>
                  </div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[400px]">
            {/* Large Feature */}
            <div className="md:col-span-2 relative group overflow-hidden rounded-3xl bg-slate-900 border border-white/10 hover:border-emerald-500/30 transition-all duration-500">
            ...
            {/* Small Feature 2 */}
            <div className="relative group overflow-hidden rounded-3xl bg-slate-900 border border-white/10 hover:border-emerald-500/30 transition-all duration-500">
              <div className="p-10 flex flex-col h-full justify-between">
                <div>
      ...
      <section className="py-40 px-6 relative overflow-hidden">
        <div className="absolute inset-0 bg-emerald-500/10 skew-y-3 transform origin-bottom-left scale-110"></div>
