-- =====================================================
-- ML FASES 2 + 4: SCRIPT COMBINADO
-- =====================================================
-- Este script combina Fase 2 (Embeddings) y Fase 4 (A/B Testing)
-- para ejecutar en una sola operación
-- =====================================================
...
-- 5. FUNCIÓN: find_similar_predictions
...
-- 7. COLUMNA: model_version en predictions
DO $$
BEGIN
  IF NOT EXISTS (
...
-- 8. VISTA: model_performance_comparison
...
-- 9. INSERTAR VERSIONES INICIALES
