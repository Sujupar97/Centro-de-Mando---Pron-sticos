...
async function rescuePicks() {
    console.log("Starting Rescue Mission for Report 19451998 -> Fixture 1400877");
    ...
    picksToInsert.forEach(p => console.log(`- ${p.market} ${p.selection} (${p.p_model})`));

    // 2. Clear existing picks for this fixture (to avoid duplicates if any exists under this ID)
